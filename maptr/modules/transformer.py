...
from mmengine.model import BaseModule, ModuleList, Sequential, bias_init_with_prob, xavier_init, constant_init
...
class MapTRPerceptionTransformer(BaseModule):
    ...
    def attn_bev_encode(
        ...
        if bev_queries.device != device:
            bev_queries = bev_queries.to(device)
