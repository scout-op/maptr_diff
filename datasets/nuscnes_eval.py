...
# Use compatibility layer for axis_aligned_iou_3d
from projects.mmdet3d_plugin.core.bbox.iou_utils import try_import_axis_aligned_iou_3d
axis_aligned_iou_3d = try_import_axis_aligned_iou_3d()
