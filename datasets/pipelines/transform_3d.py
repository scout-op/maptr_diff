...
# DataContainer is deprecated in mmcv 2.x, use dict instead
# But for backward compatibility, we define a simple wrapper
class DataContainer:
    ...
    def __call__(self, results):
        ...
        Returns:
            dict: The result dict contains the following keys
                ...
                - ``img_metas``
        """
        # If results is already in Pack3DDetInputs format, pass through
