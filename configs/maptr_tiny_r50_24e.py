...
# MapTR Tiny R50 24 epochs configuration
# Adapted for MMDetection3D 1.x
...
model = dict(
    ...
    train_cfg=dict(pts=dict(
        ...
        assigner=dict(
            ...
            pc_range=point_cloud_range))),
    test_cfg=dict(pts=dict(max_per_img=50)))
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        box_type_3d='LiDAR',
        # Force full init and serialize data for multi-worker
        lazy_init=False,
