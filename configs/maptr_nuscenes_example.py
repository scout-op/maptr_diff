...
"""
MapTR Example Configuration for NuScenes
这是一个用于 NuScenes 数据集的最小示例配置
"""
...
ann_file = 'data/nuscenes/train/nuscenes_infos_temporal_train.pkl'
map_ann_file = 'data/nuscenes/train/nuscenes_map_ann.json'
...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        interval=1,
        max_keep_ckpts=3,
        save_best='NuScenes/chamfer_mAP',
        rule='greater'),
...
# Working directory
work_dir = './work_dirs/maptr_nuscenes_example'
